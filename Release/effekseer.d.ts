...
// =======
    ...
    * Initialize Effekseer.js.
    * This function must be called at first if use WebAssembly
    * @param {ArrayBuffer} wasmBinary A WASM binary
    * @param {function=} onload A function that is called at loading complete
    * @param {function=} onerror A function that is called at loading error.
    */
    export function initRuntimeWithWasmBinary(wasmBinary: ArrayBuffer, onload: () => void, onerror: () => void): void;
// >>>>>>> CHANGED
    ...
    */
    ...
    export class EffekseerContext {
        ...
        */
        // =======
        /**
         * Load the effect data (and resources) from the binary asset.
         * @param asset An effect binary asset.
         * @param {number} scale A magnification rate for the effect. The effect is loaded magnificating with this specified number.
         * @param {function=} onload A function that is called at loading complete
         * @param {function=} onerror A function that is called at loading error. First argument is a message. Second argument is an url.
         */
        loadEffectBinaryAsset(asset: g.BinaryAsset, scale: number, onload?: () => void, onerror?: (reason: string, path: string) => void): EffekseerEffect;
         ...
         * @param {function=} onerror A function that is called at loading error. First argument is a message. Second argument is an url.
         */
        loadEffectBinaryAsset(asset: g.BinaryAsset, onload?: () => void, onerror?: (reason: string, path: string) => void): EffekseerEffect;
        // >>>>>>> CHANGED
    ...
    export namespace utils {
         ...
         *
         * @param renderer - レンダラ
         * @param settings - EffekseerContext#init に渡される設定
         * @returns コンテキスト
         */
        export function createEffekseerContext(renderer: g.Renderer, settings?: object): EffekseerContext;
        /**
         * Effekseer による描画を行う。
         *
         * @param renderer - レンダラ
         ...
         */
        export function renderEffekseer(renderer: g.Renderer, context: EffekseerContext): void;
    }
// <<<<<<< ORIGINAL
/*
}
